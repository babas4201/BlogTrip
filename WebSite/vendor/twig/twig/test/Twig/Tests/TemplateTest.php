...
class Twig_Tests_TemplateTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetAttributeWithTemplateAsObject($useExt)
    {
        ...
        $template = new Twig_TemplateTest($twig, $useExt, 'basedIndex.twig');
    ...
    /**
     * @group legacy
     * @expectedDeprecation Calling "getString" on template "index1.twig" from template "basedIndex.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0.
     * @expectedDeprecation Calling "getString" on template "index1.twig" from template "basedIndex.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0.
     * @expectedDeprecation Calling "getTrue" on template "index1.twig" from template "basedIndex.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0.
     * @expectedDeprecation Calling "getTrue" on template "index1.twig" from template "basedIndex.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0.
     * @expectedDeprecation Calling "getZero" on template "index1.twig" from template "basedIndex.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0.
     * @expectedDeprecation Calling "getZero" on template "index1.twig" from template "basedIndex.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0.
     * @expectedDeprecation Calling "getEmpty" on template "index1.twig" from template "basedIndex.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0.
     * @expectedDeprecation Calling "getEmpty" on template "index1.twig" from template "basedIndex.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0.
     * @expectedDeprecation Calling "renderBlock" on template "basedIndex.twig" from template "basedIndex.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0. Use block("name") instead).
     * @expectedDeprecation Calling "displayBlock" on template "basedIndex.twig" from template "basedIndex.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0. Use block("name") instead).
     * @expectedDeprecation Calling "hasBlock" on template "basedIndex.twig" from template "basedIndex.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0. Use "block("name") is defined" instead).
     * @expectedDeprecation Calling "render" on template "basedIndex.twig" from template "basedIndex.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0. Use include("basedIndex.twig") instead).
     * @expectedDeprecation Calling "display" on template "basedIndex.twig" from template "basedIndex.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0. Use include("basedIndex.twig") instead).
     * @expectedDeprecation Calling "renderBlock" on template "index1.twig" from template "basedIndex.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0. Use block("name", template) instead).
     * @expectedDeprecation Calling "displayBlock" on template "index1.twig" from template "basedIndex.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0. Use block("name", template) instead).
     * @expectedDeprecation Calling "hasBlock" on template "index1.twig" from template "basedIndex.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0. Use "block("name", template) is defined" instead).
     * @expectedDeprecation Calling "render" on template "index1.twig" from template "basedIndex.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0. Use include("index1.twig") instead).
     * @expectedDeprecation Calling "display" on template "index1.twig" from template "basedIndex.twig" is deprecated since version 1.28 and won't be supported anymore in 2.0. Use include("index1.twig") instead).
     */
    public function testGetAttributeWithTemplateAsObjectForDeprecations()
    {
        ...
        $template = new Twig_TemplateTest($twig, false, 'basedIndex.twig');
        $template1 = new Twig_TemplateTest($twig, false, 'index1.twig');
    ...
    public function getGetAttributeTests()
    {
        ...
        $tests = array_merge($tests, array(
            array(false, null, 42, 'a', array(), $anyType, false, 'Impossible to access an attribute ("a") on a integer variable ("42") in "basedIndex.twig".'),
            array(false, null, 'string', 'a', array(), $anyType, false, 'Impossible to access an attribute ("a") on a string variable ("string") in "basedIndex.twig".'),
            array(false, null, array(), 'a', array(), $anyType, false, 'Key "a" does not exist as the array is empty in "basedIndex.twig".'),
        ));
...
class Twig_TemplateTest extends Twig_Template
{
    ...
    public function __construct(Twig_Environment $env, $useExtGetAttribute = false, $name = 'basedIndex.twig')
    {
