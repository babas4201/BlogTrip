...
abstract class Twig_Tests_Profiler_Dumper_AbstractTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        return $this->generateProfile('main', 1, true, 'template', 'basedIndex.twig', $subProfiles);
    }
    ...
    {
        return $this->generateProfile('foo', 0.0001, false, 'macro', 'basedIndex.twig', $subProfiles);
    }
